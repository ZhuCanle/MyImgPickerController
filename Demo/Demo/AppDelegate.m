...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [navigationController.navigationBar setBackgroundImage:[[UIImage imageNamed:@"btn_black_lit.png"] stretchableImageWithLeftCapWidth:70 topCapHeight:25] forBarMetrics:UIBarMetricsDefault];
    UITabBarController *tabBarController = [[UITabBarController alloc] init];
    tabBarController.tabBar.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:246/255.0 alpha:1.0];
